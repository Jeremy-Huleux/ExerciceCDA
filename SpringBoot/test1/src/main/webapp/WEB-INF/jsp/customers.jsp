...
<body id="page-top">
	...
	<section>
		<div class="container px-4">
          ...
          <div class="text-end">
            <a type="button" class="btn btn-primary btn-md" href="/customers/add">Ajouter clients</a>
          </div>
					<table class="table">
                        <thead class="thead-dark">
                          ...
                          <th scope="col">Support Rep ID</th>
                          <th scope="col"></th>
                          </tr>
                        </thead>
                        <tbody>
                          ...
                          <tr>
                            ...
                            href="/customers/update?id=${customer}">Modifier</a>
                            <a type="button" class="btn btn-warning"
                            href="/customers/delete?id=${customer}">Supprimer</a></td>
                          </tr>
                          </c:forEach>
                        </tbody>
                        </table>
